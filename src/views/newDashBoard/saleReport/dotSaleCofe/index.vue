...
export default {
    data(){
        return{
            ...
            //     { label: "节点类别", prop: "name", type: "normal" },
            //     { label: "节点类别", prop: "type", type: "normal" },
            //     { label: "节点类别", prop: "coordinate", type: "normal" },
    ...
    methods: {
        discountHeaderStyle1({ row, column, rowIndex, columnIndex }){
            if (rowIndex === 1 || rowIndex === 2 || rowIndex === 3) {                              //判断当rowIndex = 1 时隐藏另外领两个头部单元格
                return { display: 'none' }
            }
        },
       ...
       addNewUser(){
        ...
        mergeData(){
          ...
          for (var i = 0; i < data.length; i++) {
            if (i === 0) {
              ...
              if (data[i].header1 === data[i - 1].header1) {
              ...
              if (data[i].header1 === data[i - 1].header1 && data[i].header2 === data[i - 1].header2) {
              ...
              if (data[i].header1 === data[i - 1].header1 && data[i].header2 === data[i - 1].header2 && data[i].header3 === data[i - 1].header3) {
        ...
        showDataList(){
            ...
            let params = {
                url: api['sellReportForBranch'].url,
                method: 'post',
                data: {
