<template>
  <div class="app-container">
    ...
    <el-table-column align="center" prop="titled" :label="titled">
            ...
            <el-table-column prop="allData" label="日期" align="center">
            </el-table-column>
            <el-table-column prop="allData" label="已发送金额" align="center">
            </el-table-column>
            <el-table-column prop="allData" label="封账" align="center">
            </el-table-column>
            <el-table-column prop="allData" label="实际入账" align="center">
            </el-table-column>
            <el-table-column prop="allData" label="入账差异" align="center">
            </el-table-column>
    </el-table-column>
