<template>
  <div class="app-container">
    ...
    <el-table-column align="center" prop="titled" :label="titled">
        ...
        <el-table-column prop="allData" label="未响应数据" align="center">
        </el-table-column>
        <el-table-column prop="allData" label="未发送数据" align="center">
        </el-table-column>
        <el-table-column prop="allData" label="未到账数据" align="center">
        </el-table-column>
