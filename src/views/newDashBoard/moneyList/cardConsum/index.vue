<template>
  <div class="app-container">
    ...
    <el-table-column align="center" prop="titled" :label="titled">
            <el-table-column prop="allData" label="服务方" align="center">
            </el-table-column>
            <el-table-column prop="allData" label="卡号" align="center">
            </el-table-column>
            <el-table-column prop="allData" label="开户人姓名" align="center">
            </el-table-column>
            <el-table-column prop="allData" label="银行卡号" align="center">
            </el-table-column>
            <el-table-column prop="allData" label="开户行" align="center">
            </el-table-column>
            <el-table-column prop="allData" label="退费金额" align="center">
            </el-table-column>
            <el-table-column prop="allData" label="调整类型" align="center">
            </el-table-column>
            <el-table-column prop="allData" label="争议处理结果时间" align="center">
            </el-table-column>
            <el-table-column prop="allData" label="清分目标日" align="center">
            </el-table-column>
            <el-table-column prop="allData" label="入口时间" align="center">
            </el-table-column>
            <el-table-column prop="allData" label="出口时间" align="center">
            </el-table-column>
            <el-table-column prop="allData" label="消费金额" align="center">
            </el-table-column>
            <el-table-column prop="allData" label="行驶路径" align="center">
            </el-table-column>
            <el-table-column prop="allData" label="车牌" align="center">
            </el-table-column>
    </el-table-column>
