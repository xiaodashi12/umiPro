<template>
  <div class="app-container">
    ...
    <el-table-column align="center" prop="titled" :label="titled">
      ...
      <el-table-column label="合作单位T日充值报表" align="center">
        <el-table-column prop="allData" label="合计" align="center">
        </el-table-column>
      </el-table-column>
      <el-table-column label="通行宝T日充值报表" align="center">
        <el-table-column prop="allData" label="充值" align="center"></el-table-column>
        <el-table-column prop="allData" label="退款" align="center"></el-table-column>
        <el-table-column prop="allData" label="其他" align="center"></el-table-column>
