<template>
  <div class="app-container">
    ...
    <el-table-column align="center" label="网上充值资金情况汇总表（个人）">
        <el-table-column fixed prop="tsTimesp" label="日期" align="center"></el-table-column>
        <el-table-column prop="allData" label="转入金额（农行）" align="center">
        </el-table-column>
        <el-table-column prop="allData" label="转入金额（通行宝）" align="center"></el-table-column>
        <el-table-column prop="allData" label="差额" align="center"></el-table-column>
        <el-table-column prop="allData" label="转出金额" align="center"></el-table-column>
        <el-table-column prop="allData" label="关账" align="center"></el-table-column>
