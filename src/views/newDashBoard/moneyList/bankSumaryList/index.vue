<template>
  <div class="app-container">
    ...
    <el-table-column align="center" label="招行APP充值圈存区间报表（区间）">
      <el-table-column fixed prop="tsTimesp" label="日期" align="center"></el-table-column>
      <el-table-column label="银联T日充值报表" align="center">
        <el-table-column prop="allData" label="合计" align="center">
        </el-table-column>
      </el-table-column>
      <el-table-column label="通行宝T日充值、设备报表" align="center">
        <el-table-column prop="allData" label="充值金额" align="center"></el-table-column>
        <el-table-column prop="allData" label="退款金额" align="center"></el-table-column>
        <el-table-column prop="allData" label="蓝牙盒子数量" align="center"></el-table-column>
        <el-table-column prop="allData" label="蓝牙盒子金额" align="center"></el-table-column>
        <el-table-column prop="allData" label="合计" align="center"></el-table-column>
      </el-table-column>
      <el-table-column label="差异" align="center">
        <el-table-column prop="allData" label="合计" align="center">
        </el-table-column>
      </el-table-column>
      <el-table-column label="T日圈存金额" align="center">
        <el-table-column prop="allData" label="合计" align="center">
        </el-table-column>
      </el-table-column>
      <el-table-column prop="allData" label="关账" align="center">
        </el-table-column>
    </el-table-column>
...
export default {
    data(){
        return{
            ...
            titled:'',
            titleLabel:[
                {label:'建行惠龙易通APP充值圈存汇总表（区间）',value:'0'},
                {label:'骆驼加油充值圈存汇总报表（区间）',value:'1'},
                {label:'苏宁金融充值圈存区间报表（区间）',value:'2'},
                {label:'G7合作业务充值圈存区间报表（区间）',value:'3'},
                {label:'货车帮合作业务充值圈存区间报表（区间）',value:'4'},
                {label:'金润合作业务充值圈存区间报表（区间）',value:'5'},
                {label:'坦程合作业务充值圈存区间报表（区间）',value:'6'},
                {label:'微信小程序充值圈存区间报表（区间）',value:'7'},
            ],
            // 遮罩层
            loading: true,
            hasOwnData:[],
