...
const plateMenuToListMap = new Map([
    ...
    ['roleMenu', "菜单权限"],
    ['branchReport', "充值报表"],
    ['branchReportCopy', "充值报表"],
    ['branchReportCofe', "充值报表"],
    ['allReport', "所有网点充值"],
    ['onwerReport', "资金来源细分报表"],
    ['onwerReportCopy', "资金来源细分报表"],
    ['onwerReportCofe', "资金来源细分报表"],
    ['findRoleList', "角色查询"],
    ...
    ['pianquPass', "片区校核"],
    ['caiwuPass', "财务审核"],
    ['bankDataList', "联名记账卡消费区间表"],
    ['sutongRefundForm', "苏通卡客户销户退款批量审批单"],
    ['sinopecRechargeReport', "中石化充值报表"],
    ['sinopecRechargeReportCopy', "中石化充值报表"],
    ['sinopecRechargeReportCofe', "中石化充值报表"],
    ['sutongDailyReport', "服务区苏通卡服务点资金日报表"],
    ['sutongDailyReportCopy', "服务区苏通卡服务点资金日报表"],
    ['sutongDailyReportCofe', "服务区苏通卡服务点资金日报表"],
    ['intervalReport', "苏通卡消费区间报表"],
    ['clearNotice', "清分通知书"],
    ['etcRefundForm', "ETC退费确认表"],
    ['consumBookCard', "托收记账卡消费区间表"],
